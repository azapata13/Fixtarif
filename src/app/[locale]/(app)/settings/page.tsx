import { Globe2, Ruler, Save, Scale } from "lucide-react";
...
export default async function SettingsPage({ params, searchParams }: SettingsPageProps) {
  ...
  return (
    <>
      ...
      <form action={updateSettingsAction} className="rounded-[24px] border border-[var(--line)] bg-white p-6 shadow-sm">
        ...
        {canManage ? (
          <button className="primary-button mt-6 inline-flex items-center justify-center gap-2" type="submit">
